          ...
          {rows.map((row) => (
            <tr
              ...
              className={clsx(
                ...
                row.inventory_id === selectedId && 'bg-primary-50',
              )}
            >
              <td className="px-3 py-2 font-mono text-xs text-neutral-800">{row.facility_id}</td>
              <td className="px-3 py-2 text-neutral-700">{row.period}</td>
              <td className="px-3 py-2 text-neutral-700">{row.operator}</td>
